...
from common_models.util.api_func import PaginationInfo
...
class Notification(SQLModel, table=True):
    ...
    footer_s3_url: Optional[str] = Field(nullable=True)
    footer: Optional[str] = Field(nullable=True)
    body_s3_url: Optional[str] = Field(nullable=True)
    message_email: Optional[str] = Field(nullable=True)
    header_s3_url: Optional[str] = Field(nullable=True)
    ...
    class Write(BaseModel):
        ...
        footer_s3_url: Optional[str] = Field(
            nullable=True
        )  # this will be enable for the new microservice
        footer: Optional[str] = Field(nullable=True)
        body_s3_url: Optional[str] = Field(
            nullable=True
        )  # this will be enable for the new microservice
        message_email: Optional[str] = Field(nullable=True)
        header_s3_url: Optional[str] = Field(
            nullable=True
        )  # this will be enable for the new microservice
        header: Optional[str] = Field(nullable=True)

        member_message: Optional[str]
        location_message: Optional[str]
    ...
    class Read(BaseModel):
        ...
        id_member: Optional[UUID]
        member: Optional[Member]  # TODO: remove member field
        recipient_type: Optional[RecipientType]
